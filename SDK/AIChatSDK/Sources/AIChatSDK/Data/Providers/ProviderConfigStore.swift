...
@MainActor
public protocol ProviderConfigStore: AnyObject, Sendable {
...
@MainActor
public final class UserDefaultsProviderConfigStore: ProviderConfigStore {

    public private(set) var configs: [ProviderConfig] = []
    public var onChange: (() -> Void)?

    private let defaults: UserDefaults
    private let storageKey = "providers.configs"
    private let logger = SDKLogger.providerConfiguration
    ...
    public func save(_ config: ProviderConfig) {
