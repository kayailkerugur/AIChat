...
public struct AIChatVoiceView: View {
    ...
    private var pushToTalkButton: some View {
        Circle()
            .fill(viewModel.isRecording ? theme.recordingColor : theme.accentColor)
